...
from rachetwrench.ir.types import PrimitiveType, StructType, PointerType, LabelType, VoidType, VectorType, ArrayType
...
def get_value_name(value):
    from rachetwrench.ir.types import i8
...
def get_thread_local(value):
    from rachetwrench.ir.values import ThreadLocalMode
...
def get_linkage(value):
    from rachetwrench.ir.values import GlobalLinkage
