from rachetwrench.codegen.obj import (
    MCObjectStream,
    MCObjectWriter,
...
from rachetwrench.codegen.mc import ELFSymbolType, ELFSymbolBinding, ELFSymbolVisibility

from rachetwrench.codegen.assembler import MCAsmBackend, MCAssembler, MCAsmLayout, evaluate_expr_as_constant
...
class ELFObjectStream(MCObjectStream):
    ...
    def emit_value(self, value: MCExpr, size: int):
        from rachetwrench.codegen.mc import get_fixup_kind_for_size
...
class X64ELFObjectWriter(ELFObjectTargetWriter):
    ...
    def get_reloc_type(self, context: MCContext, target: MCValue, fixup: MCFixup, is_pcrel):
        ...
        from rachetwrench.codegen.x64_asm_printer import X64FixupKind
...
class ARMELFObjectWriter(ELFObjectTargetWriter):
    ...
    def get_reloc_type(self, context: MCContext, target: MCValue, fixup: MCFixup, is_pcrel):
        ...
        from rachetwrench.codegen.arm_asm_printer import ARMFixupKind
...
class AArch64ELFObjectWriter(ELFObjectTargetWriter):
    ...
    def get_reloc_type(self, context: MCContext, target: MCValue, fixup: MCFixup, is_pcrel):
        ...
        from rachetwrench.codegen.aarch64_asm_printer import AArch64FixupKind, AArch64MCExprVarKind
...
class RISCVELFObjectWriter(ELFObjectTargetWriter):
    ...
    def get_reloc_type(self, context: MCContext, target: MCValue, fixup: MCFixup, is_pcrel):
        ...
        from rachetwrench.codegen.riscv_asm_printer import RISCVFixupKind
