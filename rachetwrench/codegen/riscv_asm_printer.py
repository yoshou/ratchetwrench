...
from rachetwrench.codegen.riscv_gen import RISCVMachineOps
import zlib
import io
...
class RISCVMCInstLower:
    ...
    def lower_symbol_operand(self, operand: MachineOperand, symbol: MCSymbol):
        from rachetwrench.codegen.riscv_gen import RISCVOperandFlag
...
class RISCVAsmPrinter(AsmPrinter):
    ...
    def emit_machine_cp_value(self, data_layout, value):
        from rachetwrench.codegen.riscv_gen import RISCVConstantPoolKind, RISCVConstantPoolModifier
