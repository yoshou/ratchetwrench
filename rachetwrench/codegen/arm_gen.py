...
from rachetwrench.codegen.arm_def import *
...
class ARMTargetMachine:
    ...
    def add_mc_emit_passes(self, pass_manager, mccontext, output, is_asm):
        from rachetwrench.codegen.arm_asm_printer import ARMAsmInfo, MCAsmStream, ARMCodeEmitter, ARMAsmBackend, ARMAsmPrinter
        from rachetwrench.codegen.coff import WinCOFFObjectWriter, WinCOFFObjectStream
        from rachetwrench.codegen.elf import ELFObjectStream, ELFObjectWriter, ARMELFObjectWriter
        from rachetwrench.codegen.arm_constant_island import ARMConstantIsland
