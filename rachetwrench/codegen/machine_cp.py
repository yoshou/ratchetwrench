...
class MachineCopyProp(MachineFunctionPass):
    ...
    def track_copy(self, inst):
        from rachetwrench.codegen.spec import iter_reg_units
    ...
    def find_backward_copy(self, inst, reg):
        from rachetwrench.codegen.spec import iter_reg_units, iter_reg_aliases
    ...
    def forward_cp_bb(self, bb: MachineBasicBlock):
        from rachetwrench.codegen.mir_emitter import TargetDagOps
