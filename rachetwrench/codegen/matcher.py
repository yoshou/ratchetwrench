from rachetwrench.codegen.dag import Dag
...
def construct(inst, node, dag: Dag, result: MatcherResult):
    from rachetwrench.codegen.types import ValueType, MachineValueType
    from rachetwrench.codegen.spec import MachineRegisterDef
...
class NodePatternMatcher(PatternMatcher):
    ...
    def match(self, node, values, idx, dag):
        ...
        from rachetwrench.codegen.dag import VirtualDagOps, DagValue, StoreDagNode, LoadDagNode
...
def create_matcher(matcher_or_tuple):
    from rachetwrench.codegen.spec import MachineRegisterClassDef, MachineRegisterDef
...
from rachetwrench.codegen.dag import LoadExtType
...
class ValueTypeMatcher(NodeValuePatternMatcher):
    def __init__(self, value_type, sub_matcher, operands, name=None):
        ...
        from rachetwrench.codegen.spec import get_builder
    ...
    def construct(self, node, dag: Dag, result: MatcherResult):
        ...
        from rachetwrench.codegen.dag import DagNode, DagValue
...
class ValueTypeMatcherGen:
    def __init__(self, value_type, **props):
        from rachetwrench.codegen.types import MachineValueType
...
from rachetwrench.codegen.dag import CondCode
