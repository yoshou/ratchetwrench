...
def is_passive_node(node):
    from rachetwrench.codegen.dag import ConstantDagNode, ConstantFPDagNode, RegisterDagNode, GlobalAddressDagNode, BasicBlockDagNode
    from rachetwrench.codegen.dag import FrameIndexDagNode, ConstantPoolDagNode, ExternalSymbolDagNode
