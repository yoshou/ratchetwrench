...
from rachetwrench.codegen.x64_def import *
...
class X64TargetMachine(TargetMachine):
    ...
    def add_mc_emit_passes(self, pass_manager, mccontext, output, is_asm):
        from rachetwrench.codegen.x64_asm_printer import X64AsmInfo, MCAsmStream, X64CodeEmitter, X64AsmBackend, X64AsmPrinter, X64IntelInstPrinter
        from rachetwrench.codegen.coff import WinCOFFObjectWriter, WinCOFFObjectStream
        from rachetwrench.codegen.elf import ELFObjectStream, ELFObjectWriter, X64ELFObjectWriter
