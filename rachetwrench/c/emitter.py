...
from rachetwrench.c.sema import is_pointer_type
from rachetwrench.c.sema import get_type_of
from rachetwrench.c.symtab import FunctionSymbol, VariableSymbol
from rachetwrench.ast.node import *
from rachetwrench.ir.types import *
from rachetwrench.ir.values import *
from rachetwrench.ir.data_layout import *

import rachetwrench.ast as ast
...
def get_func_name(name):
    from rachetwrench.glsl.sema import FuncSignature
...
def build_ir_expr_func_call(node, block, ctx):
    from rachetwrench.ir.types import PointerType
...
def emit_ir(ast, abi, module):
    ...
    for decl in ast:
        ...
        if isinstance(decl, TypedFunctionProto):
            ...
            from rachetwrench.c.parse import StorageClass
