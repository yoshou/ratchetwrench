...
class COFFObjectFile(ObjectFile):
    ...
    def get_section_alignment(self, section):
        from codegen.coff import IMAGE_SCN_TYPE_NO_PAD
    ...
    def get_section_is_text(self, section):
        from codegen.coff import IMAGE_SCN_CNT_CODE
    ...
    def get_symbol_type(self, symbol):
        from codegen.coff import IMAGE_SYM_DTYPE_FUNCTION
    ...
    def get_symbol_flags(self, symbol):
        from codegen.coff import IMAGE_SYM_ABSOLUTE, IMAGE_SYM_CLASS_EXTERNAL, IMAGE_SYM_UNDEFINED
